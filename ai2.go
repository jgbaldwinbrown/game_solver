...
func init_state() state {
    ...
    s.enemies = append(s.enemies, enemy{p: pos{x: 4, y: 8}, move_dir: vec{x: 0, y: 1}, move_count: 3, alive: true})
    s.enemies = append(s.enemies, enemy{p: pos{x: 6, y: 9}, move_dir: vec{x: 0, y: 1}, move_count: 2, alive: true})
    s.enemies = append(s.enemies, enemy{p: pos{x: 8, y: 10}, move_dir: vec{x: 0, y: 1}, move_count: 1, alive: true})
    s.enemies = append(s.enemies, enemy{p: pos{x: 9, y: 10}, move_dir: vec{x: 0, y: 1}, move_count: 1, alive: true})
    s.turn = 10
    s.time_bonus = 0
    return s
}
